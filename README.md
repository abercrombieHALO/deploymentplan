...
- [Functionality](#functionality)
  * [Location-level](#location-level)
	+ [Add/remove/rename a location](#addremoverename-a-location)
  * [Task-level](#task-level)
	+ [Add/remove a task](#add-or-remove-a-task)
  	+ [Rename a task](#rename-a-task)
  * [Section-level](#section-level)
  	+ [Add a new section](#add-a-new-section)   
  	+ [Move sections to a new task](#move-sections-to-a-new-task) 
  	+ [Change the donor for a section](#change-the-donor-for-a-section) 
  * [Person-level](#person-level)
	+ [Add or remove a person](#add-or-remove-a-person) 
  	+ [Move people to a new task](#move-a-personpeople-to-a-new-section) 
